    ...
    return (
      <View style={styles.mainContainer}>
        <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'center'}}>
            <View style={{flex: 1}}>
                <TextFontTitillium style={{fontSize: 30, padding: 15, marginLeft: 15}}>~</TextFontTitillium>
            </View>
            <View style={{flex: 4}} >
                <TextFontTitillium style={styles.textStyle}>
                     It looks like there was a mistake with your email or password input.
                </TextFontTitillium>
            </View>
            <View style={{flex: 1}}>
                <TextFontTitillium style={{fontSize: 30, padding: 15, marginRight: 15}}>~</TextFontTitillium>
            </View>
        </View>
             <TextFontTitillium style={styles.textStyle}>
                    {"\n"}
