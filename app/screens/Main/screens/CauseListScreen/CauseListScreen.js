...
// class GenericAnimatedButton extends Component {
//     render() {
//       return (
//         <TouchableHighlight
...
class CauseListScreen extends Component {
    ...
    _onPressSelectItem = () => {
        if (this.state.itemPressed) {
            ...
            this.setState({
                pageBackgroundImage:
                    CAUSE_LIST_DATA[this._carousel.currentIndex]
                        .gradientCauseImage,
                pageDescriptionText:
                ...
                >
                    ...
                    >
                        <TextFontTitillium style={styles.carouselItemSubTitle1}>
                            with{" "}
                            <Text style={styles.carouselItemSubTitle2}>
                                {item.company}
                            </Text>
                        </TextFontTitillium>
                    </View>
            ...
            <View style={styles.layoutStyle}>
                ...
                >
                    ...
                    >
                        <ScrollView>
                            <TextFontTitillium
                                style={{ color: "#f6f6f6", fontSize: 15 }}
                            >
                                {"     "}
